...
const resources=[
 ...
 ['参考','個別最適な学び・協働的な学び','指導の個別化と学習の個性化、ICTを活用した学習状況の把握について示した背景資料','https://www.mext.go.jp/a_menu/shotou/new-cs/senseiouen/mext_01491.html','文部科学省'],
 ['JSON','ナレッジグラフサンプル','微分・三角関数・暗号通信の3種類を、レイヤーと依存関係から閲覧',`${base}/knowledge-graphs/`,'ブラウザで閲覧'],
 ['CODE','GitHubリポジトリ','現時点ではKnowledge Graphを生成するシステムのソースのみ公開しています。','https://github.com/KTaisei/KnowledgeGraph','公開準備中'],
];
